...
export function HeroFallback({ color = "#ff3d00" }) {
  return (
    <div className="absolute inset-0 flex items-center justify-center overflow-hidden bg-ink">
      <div
        className="absolute h-[55vh] w-[55vh] rounded-full blur-[140px]"
      ...
      >
        <g fill="none" strokeWidth="1">
          <ellipse cx="200" cy="200" rx="170" ry="64" stroke={color} opacity="0.9" />
        ...
        <circle cx="200" cy="200" r="22" fill="#141414" stroke={color} strokeWidth="1.2" />
      </svg>
    </div>
  );
}
